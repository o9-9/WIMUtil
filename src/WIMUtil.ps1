...
$configUrl = "https://raw.githubusercontent.com/o9-9/WIMUtil/main/config/wimutil-settings.json"  # Main branch
# $configUrl = "https://raw.githubusercontent.com/o9-9/WIMUtil/dev/config/wimutil-settings.json"   # Dev branch
...
if ($configUrl -match "https://raw.githubusercontent.com/o9-9/WIMUtil/([^/]+)/config/wimutil-settings.json") {
...
if ($readerOperationSuccessful) {
    ...
    function DownloadUWXML {
        ...
        $url = "https://github.com/o9-9/UnattendedWinstall/raw/main/autounattend.xml"

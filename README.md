# o9 Windows Installation Media Utility 🧰

**Why?** WIMUtil has been successfully integrated into my larger project, [**nonsense**](https://github.com/o9-9/nonsense). Rather than maintain t9wo separate projects, I've decided to focus development efforts on nonsense, which includes all of WIMUtil's functionality and much more.

**What should you use?** For Windows installation media customization, please use:
👉 **[nonsense](https://github.com/o9-9/nonsense)** - Actively maintained, more features, better support
...
[![Latest Version](https://img.shields.io/badge/Version-0.0.3Alpha%20Latest-0078D4?style=for-the-badge&logo=github&logoColor=white)](https://github.com/o9-9/WIMUtil/releases)

### Support the Project

If **WIMUtil** has been useful to you, consider supporting the project—it truly helps!

[![Support via PayPal](https://img.shields.io/badge/Support-via%20PayPal-FFD700?style=for-the-badge&logo=paypal&logoColor=white)](https://paypal.me/shno5)
...
[![Join the Discussion](https://img.shields.io/badge/Join-the%20Discussion-2D9F2D?style=for-the-badge&logo=github&logoColor=white)](https://github.com/o9-9/WIMUtil/discussions)
...
> **Note:** For new projects, please use [nonsense](https://github.com/o9-9/nonsense) instead.
...
3. **Paste and Run the Command**:
   - Copy the following command:
     ```powershell
     irm "https://github.com/o9-9/WIMUtil/raw/main/src/WIMUtil.ps1" | iex
     ```
